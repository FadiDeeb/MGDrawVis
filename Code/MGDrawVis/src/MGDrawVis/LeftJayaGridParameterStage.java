...
public class LeftJayaGridParameterStage extends Stage{
    ...
    public Button callJayaGrid;  
    public Scene scene; 
    public long populationSize,iterations; 
    
    public LeftJayaGridParameterStage(boolean enabled)
    {
